...
public class UpdateCommand implements Command{
    ...
    public void execute(String option,Scanner scanner,String type) {
        try {
            ...
            System.out.println("Выполняется удаление элемета с id " + Integer.parseInt(option));
            System.out.println("Выполняется добавление элемета с id" + Integer.parseInt(option)+". Следуйте инструкции ниже:");
            ...
            coll.addElementWithId(new City(Integer.parseInt(option), name, new Coordinates(x, y), area, population, metersAboveSeaLevel, capital, climate, government, new Human(nameGovernor)), index);
            System.out.println("Значение элемента коллекции с id " + Integer.parseInt(option) + " обновлено");
        }
